...
RegisterCommand('ambulansprint', function(count)
	local xPlayer = ESX.GetPlayerFromId(source)
	local esya = xPlayer.getInventoryItem(item).count
	TriggerClientEvent('item:sil', source, esya.name, esya.label, count)
end)

RegisterNetEvent('esx_ambulancejob:itemnotif')
AddEventHandler('esx_ambulancejob:itemnotif', function(item,label ,count)
	local xPlayer = ESX.GetPlayerFromId(source)
	local esya = xPlayer.getInventoryItem(item).count
	TriggerClientEvent('item:sil', source, esya, label, count)
end)
...
RegisterNetEvent('esx_ambulancejob:polisitemver')
AddEventHandler('esx_ambulancejob:polisitemver', function(item, miktar)
	local xPlayer = ESX.GetPlayerFromId(source)

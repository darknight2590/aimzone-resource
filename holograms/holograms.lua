...
function Holograms()
		while true do
			Citizen.Wait(0)			
				-- Hologram No. 1
		if GetDistanceBetweenCoords( -814.45, 177.857, 76.7407, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( -814.45, 177.857, 76.7407  -1.400, "/pvparena yazarak,arenaya ısınlan ve savasmaya basla !", 4, 0.1, 0.1)
			Draw3DText( -814.45, 177.857, 76.7407  -1.600, "discord.gg/myqqGVp7JF", 4, 0.1, 0.1)
			Draw3DText( -814.45, 177.857, 76.7407  -1.800, "Olası sorunlar icin ticket acabilirsiniz.", 4, 0.1, 0.1)		
		end		
	end
end
